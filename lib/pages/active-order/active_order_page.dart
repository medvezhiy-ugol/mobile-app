        ...
        child: SingleChildScrollView(
          child: Center(
            child: Column(children: [
              ...
              const Text('Ваш заказ', style: TextStyle(
                fontSize: 16,
                color: Colors.white,
              ...
              Container(
                ...
                color: Colors.green,
                child: const Center(
                  child: Text('{ Circle Progress Bar }', style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w600,
                    color: Colors.white
                  ),),
              ...
              const Text('Заказ принят', style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w600,
                color: Colors.white
              ),),
              ...
              Container(
                ...
                height: 96,
                child: Row(children: [
                  Image.asset(A.assetsDetailPageProductImg, width: 108,),
                  const SizedBox(width: 10,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                    const Text('Донер с курицей', style: TextStyle(
                      fontSize: 16,
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    Text('Сервисный сбор', style: TextStyle(
                      color: AppColors.color808080,
                      fontSize: 16,
                      fontWeight: FontWeight.w500
                    ),),
